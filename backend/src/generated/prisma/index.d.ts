...
export namespace Prisma {
  ...
  */
  ...
  export type contatosOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "nome" | "email" | "telefone" | "favorite" | "criado_em", ExtArgs["result"]["contatos"]>
  ...
  interface contatosFieldRefs {
    ...
    readonly favorite: FieldRef<"contatos", 'Boolean'>
    readonly criado_em: FieldRef<"contatos", 'DateTime'>
  }
  ...
  export type contatosWhereInput = {
    ...
    favorite?: BoolFilter<"contatos"> | boolean
    criado_em?: DateTimeFilter<"contatos"> | Date | string
  }
  ...
  export type contatosScalarWhereWithAggregatesInput = {
    ...
    favorite?: BoolWithAggregatesFilter<"contatos"> | boolean
    criado_em?: DateTimeWithAggregatesFilter<"contatos"> | Date | string
  }
